...
def cmd_option():
    ...
    arg_parser.add_argument('--Dnorm', type=str, default='None',
                            help="Instance(IN) normalization or batch(BN) normalization")
    arg_parser.add_argument('--flayers', type=int, nargs=5, default=[0, 0, 1, 1, 1],
                            help="Layers used to calculate feature loss")
    arg_parser.add_argument('--weight', type=float, nargs=3, default=[1e0, 1e3, 1e-5],
                            help="MSE loss weight, Feature loss weight, and total variation weight")
...
def train(args):
    ...
    for e in range(args.epochs):
        ...
        for batch_idx, batch_data in enumerate(data_loader):
            ...
            random_real_sketch = search_dataset.get_real_sketch_batch(train_img.size(0), ref_img_list,
